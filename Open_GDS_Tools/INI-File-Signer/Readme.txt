...
Usage: IniFileSigner -in filename_in -out filename_out [-v]
  ...
  -out filename_out : full path to output file, which contains
                      filename_in and the signature
  -v : verbose mode
...
NOTE:  INIFileSigner.exe is licensed and may only be used if activated.  For more information or to obtain a free license to use this tool, please contact the LabVIEW Partner Program at labviewpartnerprogram@ni.com.  Please include your Name, Company, and a description of what you are creating with LabVIEW Project Provider Framework.
