...
<Project Type="Project" LVVersion="12008004">
	<Item Name="My Computer" Type="My Computer">
		...
		<Item Name="AbstractEdge.lvclass" Type="LVClass" URL="/&lt;resource&gt;/Framework/Providers/Open_GDS/UML/AbstractEdge_class/AbstractEdge.lvclass"/>
		<Item Name="CallEdge.lvclass" Type="LVClass" URL="/&lt;resource&gt;/Framework/Providers/Open_GDS/UML/CallEdge_class/CallEdge.lvclass"/>
		<Item Name="ClassRelationshipEdge.lvclass" Type="LVClass" URL="/&lt;resource&gt;/Framework/Providers/Open_GDS/UML/ClassRelationshipEdge_class/ClassRelationshipEdge.lvclass"/>
		<Item Name="GeneralPathEdge.lvclass" Type="LVClass" URL="/&lt;resource&gt;/Framework/Providers/Open_GDS/UML/GeneralPathEdge_class/GeneralPathEdge.lvclass"/>
		<Item Name="NoteEdge.lvclass" Type="LVClass" URL="/&lt;resource&gt;/Framework/Providers/Open_GDS/UML/NoteEdge_class/NoteEdge.lvclass"/>
		<Item Name="SegmentedLineEdge.lvclass" Type="LVClass" URL="/&lt;resource&gt;/Framework/Providers/Open_GDS/UML/SegmentedLineEdge_class/SegmentedLineEdge.lvclass"/>
		<Item Name="StateTransitionEdge.lvclass" Type="LVClass" URL="/&lt;resource&gt;/Framework/Providers/Open_GDS/UML/StateTransitionEdge_class/StateTransitionEdge.lvclass"/>
		<Item Name="Dependencies" Type="Dependencies">
			...
			<Item Name="-DeleteMe-AbstractEdge_Delete.vi" Type="VI" URL="/&lt;resource&gt;/Framework/Providers/Open_GDS/UML/AbstractEdge_class/utils/-DeleteMe-AbstractEdge_Delete.vi"/>
			<Item Name="-DeleteMe-AbstractEdge_GetAttributesToModify.vi" Type="VI" URL="/&lt;resource&gt;/Framework/Providers/Open_GDS/UML/AbstractEdge_class/utils/-DeleteMe-AbstractEdge_GetAttributesToModify.vi"/>
			<Item Name="-DeleteMe-AbstractEdge_GetClassAttributes.vi" Type="VI" URL="/&lt;resource&gt;/Framework/Providers/Open_GDS/UML/AbstractEdge_class/utils/-DeleteMe-AbstractEdge_GetClassAttributes.vi"/>
			<Item Name="-DeleteMe-AbstractEdge_GetClassAttributesToModify.vi" Type="VI" URL="/&lt;resource&gt;/Framework/Providers/Open_GDS/UML/AbstractEdge_class/utils/-DeleteMe-AbstractEdge_GetClassAttributesToModify.vi"/>
			<Item Name="-DeleteMe-AbstractEdge_GOOPKernel.vi" Type="VI" URL="/&lt;resource&gt;/Framework/Providers/Open_GDS/UML/AbstractEdge_class/utils/-DeleteMe-AbstractEdge_GOOPKernel.vi"/>
			<Item Name="-DeleteMe-AbstractEdge_SetModifiedAttributes.vi" Type="VI" URL="/&lt;resource&gt;/Framework/Providers/Open_GDS/UML/AbstractEdge_class/utils/-DeleteMe-AbstractEdge_SetModifiedAttributes.vi"/>
			<Item Name="-DeleteMe-AbstractEdge_SetModifiedClassAttributes.vi" Type="VI" URL="/&lt;resource&gt;/Framework/Providers/Open_GDS/UML/AbstractEdge_class/utils/-DeleteMe-AbstractEdge_SetModifiedClassAttributes.vi"/>
			<Item Name="-DeleteMe-CallEdge_GOOPKernel.vi" Type="VI" URL="/&lt;resource&gt;/Framework/Providers/Open_GDS/UML/CallEdge_class/utils/-DeleteMe-CallEdge_GOOPKernel.vi"/>
			<Item Name="-DeleteMe-CallEdge_SetModifiedAttributes.vi" Type="VI" URL="/&lt;resource&gt;/Framework/Providers/Open_GDS/UML/CallEdge_class/utils/-DeleteMe-CallEdge_SetModifiedAttributes.vi"/>
			<Item Name="-DeleteMe-ClassAttributes.ctl" Type="VI" URL="/&lt;resource&gt;/Framework/Providers/Open_GDS/UML/AbstractEdge_class/protected/-DeleteMe-ClassAttributes.ctl"/>
			<Item Name="-DeleteMe-ClassRelationshipEdge_GOOPKernel.vi" Type="VI" URL="/&lt;resource&gt;/Framework/Providers/Open_GDS/UML/ClassRelationshipEdge_class/utils/-DeleteMe-ClassRelationshipEdge_GOOPKernel.vi"/>
			<Item Name="-DeleteMe-ClassRelationshipEdge_SetModifiedAttributes.vi" Type="VI" URL="/&lt;resource&gt;/Framework/Providers/Open_GDS/UML/ClassRelationshipEdge_class/utils/-DeleteMe-ClassRelationshipEdge_SetModifiedAttributes.vi"/>
			<Item Name="-DeleteMe-GeneralPathEdge_GOOPKernel.vi" Type="VI" URL="/&lt;resource&gt;/Framework/Providers/Open_GDS/UML/GeneralPathEdge_class/utils/-DeleteMe-GeneralPathEdge_GOOPKernel.vi"/>
			<Item Name="-DeleteMe-SegmentedLineEdge_GOOPKernel.vi" Type="VI" URL="/&lt;resource&gt;/Framework/Providers/Open_GDS/UML/SegmentedLineEdge_class/utils/-DeleteMe-SegmentedLineEdge_GOOPKernel.vi"/>
			<Item Name="-DeleteMe-StateTransitionEdge_GOOPKernel.vi" Type="VI" URL="/&lt;resource&gt;/Framework/Providers/Open_GDS/UML/StateTransitionEdge_class/utils/-DeleteMe-StateTransitionEdge_GOOPKernel.vi"/>
			<Item Name="-DeleteMe-StateTransitionEdge_SetModifiedAttributes.vi" Type="VI" URL="/&lt;resource&gt;/Framework/Providers/Open_GDS/UML/StateTransitionEdge_class/utils/-DeleteMe-StateTransitionEdge_SetModifiedAttributes.vi"/>
			...
			<Item Name="AbstractNode.lvclass" Type="LVClass" URL="/&lt;resource&gt;/Framework/Providers/Open_GDS/UML/AbstractNode_class/AbstractNode.lvclass"/>
			<Item Name="ActorNode.lvclass" Type="LVClass" URL="/&lt;resource&gt;/Framework/Providers/Open_GDS/UML/ActorNode_class/ActorNode.lvclass"/>
			...
			<Item Name="ArrowHead.lvclass" Type="LVClass" URL="/&lt;resource&gt;/Framework/Providers/Open_GDS/UML/ArrowHead_class/ArrowHead.lvclass"/>
			...
			<Item Name="BentStyle.lvclass" Type="LVClass" URL="/&lt;resource&gt;/Framework/Providers/Open_GDS/UML/BentStyle_class/BentStyle.lvclass"/>
			...
			<Item Name="InterfaceNode.lvclass" Type="LVClass" URL="/&lt;resource&gt;/Framework/Providers/Open_GDS/UML/InterfaceNode_class/InterfaceNode.lvclass"/>
			...
			<Item Name="NoteNode.lvclass" Type="LVClass" URL="/&lt;resource&gt;/Framework/Providers/Open_GDS/UML/NoteNode_class/NoteNode.lvclass"/>
			<Item Name="PackageNode.lvclass" Type="LVClass" URL="/&lt;resource&gt;/Framework/Providers/Open_GDS/UML/PackageNode_class/PackageNode.lvclass"/>
			...
			<Item Name="PointNode.lvclass" Type="LVClass" URL="/&lt;resource&gt;/Framework/Providers/Open_GDS/UML/PointNode_class/PointNode.lvclass"/>
			...
			<Item Name="Rectangel GetRectInfo.vi" Type="VI" URL="/&lt;resource&gt;/Framework/Providers/Open_GDS/UML/General/Rectangle/Rectangel GetRectInfo.vi"/>
			...
			<Item Name="RectangularNode.lvclass" Type="LVClass" URL="/&lt;resource&gt;/Framework/Providers/Open_GDS/UML/RectangularNode_class/RectangularNode.lvclass"/>
			...
			<Item Name="UMLEditor BusyDialog.vi" Type="VI" URL="/&lt;resource&gt;/Framework/Providers/Open_GDS/UML/UMLEditor/UMLEditor BusyDialog.vi"/>
			<Item Name="UMLEditor BusyDialogAction.ctl" Type="VI" URL="/&lt;resource&gt;/Framework/Providers/Open_GDS/UML/UMLEditor/UMLEditor BusyDialogAction.ctl"/>
			<Item Name="UMLEditor ControlBusyDialog.vi" Type="VI" URL="/&lt;resource&gt;/Framework/Providers/Open_GDS/UML/UMLEditor/UMLEditor ControlBusyDialog.vi"/>
			<Item Name="UMLEditor EditorActionType.ctl" Type="VI" URL="/&lt;resource&gt;/Framework/Providers/Open_GDS/UML/UMLEditor/UMLEditor EditorActionType.ctl"/>
			<Item Name="UMLEditor ExecuteCommandType.ctl" Type="VI" URL="/&lt;resource&gt;/Framework/Providers/Open_GDS/UML/UMLEditor/UMLEditor ExecuteCommandType.ctl"/>
			<Item Name="UMLEditor ExportType.ctl" Type="VI" URL="/&lt;resource&gt;/Framework/Providers/Open_GDS/UML/UMLEditor/UMLEditor ExportType.ctl"/>
			<Item Name="UMLEditor FlattenCommandType.ctl" Type="VI" URL="/&lt;resource&gt;/Framework/Providers/Open_GDS/UML/UMLEditor/UMLEditor FlattenCommandType.ctl"/>
			...
			<Item Name="UMLEditor LocalVariablesType.ctl" Type="VI" URL="/&lt;resource&gt;/Framework/Providers/Open_GDS/UML/UMLEditor/UMLEditor LocalVariablesType.ctl"/>
			<Item Name="UMLEditor statesType.ctl" Type="VI" URL="/&lt;resource&gt;/Framework/Providers/Open_GDS/UML/UMLEditor/UMLEditor statesType.ctl"/>
			<Item Name="UMLEditor ToolBarSettings.vi" Type="VI" URL="/&lt;resource&gt;/Framework/Providers/Open_GDS/UML/UMLEditor/UMLEditor ToolBarSettings.vi"/>
			<Item Name="UMLEditor toolsType.ctl" Type="VI" URL="/&lt;resource&gt;/Framework/Providers/Open_GDS/UML/UMLEditor/UMLEditor toolsType.ctl"/>
			<Item Name="UMLEditor tooltype.ctl" Type="VI" URL="/&lt;resource&gt;/Framework/Providers/Open_GDS/UML/UMLEditor/UMLEditor tooltype.ctl"/>
			<Item Name="UmlEditor.lvclass" Type="LVClass" URL="/&lt;resource&gt;/Framework/Providers/Open_GDS/UML/UmlEditor_class/UmlEditor.lvclass"/>
			<Item Name="UMLEditor_FixXmlData.vi" Type="VI" URL="/&lt;resource&gt;/Framework/Providers/Open_GDS/UML/UMLEditor/UMLEditor_FixXmlData.vi"/>
			<Item Name="UMLEditor_GraphMemory.vi" Type="VI" URL="/&lt;resource&gt;/Framework/Providers/Open_GDS/UML/UMLEditor/UMLEditor_GraphMemory.vi"/>
			<Item Name="UMLEditor_HotSpotData.ctl" Type="VI" URL="/&lt;resource&gt;/Framework/Providers/Open_GDS/UML/UMLEditor/UMLEditor_HotSpotData.ctl"/>
			<Item Name="UMLEditor_HotSpotType.ctl" Type="VI" URL="/&lt;resource&gt;/Framework/Providers/Open_GDS/UML/UMLEditor/UMLEditor_HotSpotType.ctl"/>
			<Item Name="UMLEditor_PackageClasses.ctl" Type="VI" URL="/&lt;resource&gt;/Framework/Providers/Open_GDS/UML/UMLEditor/UMLEditor_PackageClasses.ctl"/>
			<Item Name="UMLEditor_PackageClasses.vi" Type="VI" URL="/&lt;resource&gt;/Framework/Providers/Open_GDS/UML/UMLEditor/UMLEditor_PackageClasses.vi"/>
			<Item Name="UMLEditor_RelativePath.vi" Type="VI" URL="/&lt;resource&gt;/Framework/Providers/Open_GDS/UML/UMLEditor/UMLEditor_RelativePath.vi"/>
			<Item Name="UMLEditor_StoredColors.ctl" Type="VI" URL="/&lt;resource&gt;/Framework/Providers/Open_GDS/UML/UMLEditor/UMLEditor_StoredColors.ctl"/>
			<Item Name="UMLEditor_StoredPathes.ctl" Type="VI" URL="/&lt;resource&gt;/Framework/Providers/Open_GDS/UML/UMLEditor/UMLEditor_StoredPathes.ctl"/>
